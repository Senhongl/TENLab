...
%struct.T = type { i32, i16 }

@__const.main.a = private unnamed_addr constant [3 x i32] [i32 1, i32 2, i32 3], align 4
@__const.main.t = private unnamed_addr constant %struct.T { i32 10, i16 12 }, align 4
...
define i32 @main() #0 {
  ...
  %5 = bitcast %struct.T* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %5, i8* align 4 bitcast (%struct.T* @__const.main.t to i8*), i64 8, i1 false)
  ret i32 0
}
